...
const CONTENT = {
  FR: {
    ...
    hero: {
      ...
      sub: "Une plateforme intelligente qui s'adapte à chaque enfant — pour que réussir à l'école ne soit plus une question de chance.",
      cta: "Commencer gratuitement",
      ctaSub: "J'ai déjà un compte",
      tagline: "Gratuit · Sans carte de crédit · Prêt en 2 minutes",
    },
    stats: [
      { valeur: "100 %", label: "Aligné sur le curriculum officiel", detail: "Du primaire au secondaire" },
    ...
    roles: [
      { role: "Élève", accroche: "Apprends à ton rythme, sans pression.", desc: "La plateforme s'ajuste à ton niveau réel du jour, détecte ce qui te bloque et t'aide à progresser pas à pas." },
  ...
  EN: {
    ...
    hero: {
      ...
      sub: "An intelligent platform that adapts to every child — so that academic success is no longer a matter of luck.",
      cta: "Get started free",
      ctaSub: "I already have an account",
      tagline: "Free · No credit card · Ready in 2 minutes",
    },
    stats: [
      { valeur: "100 %", label: "Aligned with the official curriculum", detail: "From Grade 1 to Grade 12" },
    ...
    roles: [
      { role: "Student", accroche: "Learn at your own pace, without pressure.", desc: "The platform adjusts to your real level each day, detects what's blocking you, and helps you progress step by step." },
...
const PROVINCES_INFO: Record<string, { nom: string; nomEN: string; curriculum: string; langue: Lang }> = {
  QC: { nom: "Québec",                   nomEN: "Quebec",                       curriculum: "PFEQ",                        langue: "FR" },
  ON: { nom: "Ontario",                  nomEN: "Ontario",                      curriculum: "Ontario Curriculum",          langue: "EN" },
  BC: { nom: "Colombie-Britannique",     nomEN: "British Columbia",             curriculum: "BC Curriculum",               langue: "EN" },
  AB: { nom: "Alberta",                  nomEN: "Alberta",                      curriculum: "Alberta Program of Studies",  langue: "EN" },
  SK: { nom: "Saskatchewan",             nomEN: "Saskatchewan",                 curriculum: "SK Curriculum",               langue: "EN" },
  MB: { nom: "Manitoba",                 nomEN: "Manitoba",                     curriculum: "Manitoba Curriculum",         langue: "EN" },
  NB: { nom: "Nouveau-Brunswick",        nomEN: "New Brunswick",                curriculum: "NB Curriculum",               langue: "FR" },
  NS: { nom: "Nouvelle-Écosse",          nomEN: "Nova Scotia",                  curriculum: "NS Curriculum",               langue: "EN" },
  PE: { nom: "Île-du-Prince-Édouard",    nomEN: "Prince Edward Island",         curriculum: "PEI Curriculum",              langue: "EN" },
  NL: { nom: "Terre-Neuve-et-Labrador",  nomEN: "Newfoundland and Labrador",    curriculum: "NL Curriculum",               langue: "EN" },
  YT: { nom: "Yukon",                    nomEN: "Yukon",                        curriculum: "Yukon Curriculum",            langue: "EN" },
  NT: { nom: "Territoires du Nord-Ouest",nomEN: "Northwest Territories",        curriculum: "NWT Curriculum",              langue: "EN" },
  NU: { nom: "Nunavut",                  nomEN: "Nunavut",                      curriculum: "Nunavut Curriculum",          langue: "EN" },
};
...
export function LandingContent({ multiProvince, provincesActives }: Props) {
  ...
  // Provinces activées pour le sélecteur
    ...
    <div className="min-h-screen bg-[var(--color-paper)] text-[var(--color-ink)] antialiased">
          ...
          <div className="border-b border-[var(--color-rule)] bg-[var(--color-paper-warm)] px-6 py-2.5">
            <div className="mx-auto max-w-6xl flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {provOptions.map(([code, info]) => (
                    <option key={code} value={code}>
                      {lang === "FR" ? info.nom : info.nomEN}
                    </option>
                  ))}
                </select>
      ...
      <section className={`relative overflow-hidden pt-36 pb-28 px-6 ${multiProvince && mounted ? "pt-24" : ""}`}>
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-[var(--color-rule)] bg-white/80 px-4 py-1.5 shadow-sm backdrop-blur-sm">
...
function LandingNav({ multiProvince, lang, province, provOptions, onProvinceChange, onLangToggle, c, mounted }: {
  multiProvince: boolean;
  lang: Lang;
  province: string;
  provOptions: [string, typeof PROVINCES_INFO[string]][];
